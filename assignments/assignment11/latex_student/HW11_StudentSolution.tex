...
\newcommand{\GANStudSolE}{
	...
	\end{align*}
	\begin{align*}
		\bW_1(\bP_1,\bP_2) &= \sup_{f \in \mathcal{F}_L} \vert \mathbb{E}_{x \sim \bP_1}[f(x)] - \mathbb{E}_{y \sim \bP_2}[f(y)] \vert \\
		&= \sup \vert f(x) - f(y) \vert \\
		&= 0.5
	\end{align*}
	\begin{align*}
		\bW_1(\bP_1,\bP_3) &= \sup_{f \in \mathcal{F}_L} \vert \mathbb{E}_{x \sim \bP_1}[f(x)] - \mathbb{E}_{y \sim \bP_3}[f(y)] \vert \\
		&= \sup \vert f(x) - f(y) \vert \\
		&= 1
	\end{align*}
